                ...
                <div class="col-lg-6 col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-img mb-4 text-center">
                            <img class="rounded-circle avatar-154" src="assets/imgs/template/author/author-19.png"
                                alt="magzin">
                        </div>
                        <div class="card-body text-center">
                            <h3 class="mb-3">Barbara Cartland</h3>
                            <p class="mb-0 fs-7">
                                You should write because you love the shape of stories and sentences and the <br
                                    class="d-none d-lg-block">
                                creation of different words on a page.
                            </p>
                            <div class="d-inline-flex group-social-icons bg-transparent mt-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="left">
                                ...
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">The Evolution of Modern Art: Trends Shaping the
                                        Creative World</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as
                                ...
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="%40%40link-author.html" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle"
                                            src="assets/imgs/template/author/author-9.png" alt="magzin">
                    ...
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        ...
                        <div class="card-body">
                            ...
                            <div class="left">
                                ...
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">The Power of Photography: Capturing Moments That
                                        Matter</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as
                                    counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of
                                ...
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="%40%40link-author.html" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle"
                                            src="assets/imgs/template/author/author-14.png" alt="magzin">
                    ...
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        ...
                        <div class="card-body">
                            ...
                            <div class="left">
                                ...
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">Music and Mental Health: The Healing Power of Sound
                                    </h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as
                                    counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of
                    ...
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        ...
                        <div class="card-body">
                            ...
                            <div class="left">
                                ...
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">How Social Media is Changing the Entertainment
                                        Industry</h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as
                                    counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of
                        ...
                        <div class="card-body">
                            ...
                            <div class="left">
                                ...
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="%40%40link-author.html" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle"
                                            src="assets/imgs/template/author/author-8.png" alt="magzin">
                    ...
                    <div class="article card-12 d-flex flex-md-row align-items-stretch flex-column">
                        ...
                        <div class="card-body">
                            ...
                            <div class="left">
                                ...
                                <a href="single-3.html" class="hover-underline">
                                    <h4 class="card-title mb-0 mt-3">The Future of Live Music: Virtual Concerts and Beyond
                                    </h4>
                                </a>
                                <p class="card-text text-600 fs-7 mb-0 mt-3 text-truncate-3">Once dismissed as
                                    counterculture, urban fashion has climbed its way from city sidewalks to the catwalks of
                                ...
                                <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-5">
                                    <a href="%40%40link-author.html" class="author d-flex align-items-center gap-2">
                                        <img class="avatar avatar-md rounded-circle"
                                            src="assets/imgs/template/author/author-18.png" alt="magzin">
                        ...
                        <li class="page-item">
                            <a class="icon-lg pagination_item rounded-circle icon-shape" href="#"
                                ...
                                <svg class="" xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                    ...
                                    <path d="M9.49993 6.5L4.78564 11L9.49993 15.5" stroke="#0E0E0F" stroke-width="1.28571"
                                        stroke-linecap="round" stroke-linejoin="round" />
