            ...
            <nav class="navbar navbar-expand-lg style-2">
                <div class="navbar-collapse d-none d-lg-block start" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle link-effect-1 " href="#"><span>Home</span></a>

                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle link-effect-1 " href="#"><span>Features</span></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item-has-child">
                                    <a class="dropdown-item has-child" href="#"> Archive layouts </a>
                                    <ul class="sub-menu">
                                        <li><a class="dropdown-item" href="archive-1.html">Archive 1</a></li>
                                        <li><a class="dropdown-item" href="archive-2.html">Archive 2</a></li>
                                        <li><a class="dropdown-item" href="archive-3.html">Archive 3</a></li>
                                        <li><a class="dropdown-item" href="archive-4.html">Archive 4</a></li>
                                        <li><a class="dropdown-item" href="archive-5.html">Archive 5</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item-has-child">
                                    <a class="dropdown-item has-child" href="#"> Post Layouts </a>
                                    <ul class="sub-menu">
                                        <li><a class="dropdown-item" href="single-1.html">Single 1</a></li>
                                        <li><a class="dropdown-item" href="single-2.html">Single 2</a></li>
                                        <li><a class="dropdown-item" href="single-3.html">Single 3</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item-has-child">
                                    <a class="dropdown-item has-child" href="#"> Portfolio layouts </a>
                                    <ul class="sub-menu">
                                        <li><a class="dropdown-item" href="portfolio-archive-1.html">Portfolio Archive</a>
                                        </li>
                                        <li><a class="dropdown-item" href="portfolio-details.html">Portfolio Details</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a class="dropdown-item" href="page-about.html">About us</a></li>
                                <li><a class="dropdown-item" href="page-author.html">Author posts</a></li>
                                <li><a class="dropdown-item" href="page-search-results.html">Search results</a></li>
                                <li><a class="dropdown-item" href="page-contact.html">Contact</a></li>
                                <li><a class="dropdown-item" href="page-login.html">Login</a></li>
                                <li><a class="dropdown-item" href="page-404.html">404</a></li>
                            </ul>
                        </li>
                        <li class="nav-item mega-menu-item">
                            <a class="nav-link dropdown-toggle dropdown-mega-menu link-effect-1 "
                                href="#"><span>Collections</span></a>
                                        ...
                                        <div class="article card-5">
                                                ...
                                                <div class="hover-effect-1">
                                                    <div class="position-relative card-img-top thumbnail">
                                                        <a href="single-3.html">
                                                            <img src="assets/imgs/other/img-other-9.png" alt="magzin"
                                                                class="cover-image">
                                                        </a>
                                                ...
                                                <div class="card-corner white no-border">
                                                    <a href="single-3.html" class="arrow-box">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            <path d="M13.75 6.75L19.25 12L13.75 17.25" stroke="#0E0E0F"
                                            ...
                                            <div class="card-body mt-4">
                                                <a href="single-3.html" class="hover-underline">
                                                    <h6 class="card-title mb-0">The Rise of Mindful Living in a Digital
                                                        World</h6>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="article card-5">
                                            <div class="post-link">
                                                <div class="hover-effect-1">
                                                    <div class="position-relative card-img-top thumbnail">
                                                        <a href="single-3.html">
                                                            <img src="assets/imgs/other/img-other-10.png" alt="magzin"
                                                                class="cover-image">
                                                        </a>
                                            ...
                                            <div class="card-body mt-4">
                                                <a href="single-3.html" class="hover-underline">
                                                    <h6 class="card-title mb-0">Conscious Consumerism: Making Better
                                                        Choices</h6>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="article card-5">
                                            <div class="post-link">
                                                <div class="hover-effect-1">
                                                    <div class="position-relative card-img-top thumbnail">
                                                        <a href="single-3.html">
                                                            <img src="assets/imgs/other/img-other-11.png" alt="magzin"
                                                                class="cover-image">
                                                        </a>
                                        ...
                                        <div class="article card-5">
                                            <div class="post-link">
                                                <div class="hover-effect-1">
                                                    <div class="position-relative card-img-top thumbnail">
                                                        <a href="single-3.html">
                                                            <img src="assets/imgs/other/img-other-12.png" alt="magzin"
                                                                class="cover-image">
                                                        </a>
                                            ...
                                            <div class="card-body mt-4">
                                                <a href="single-3.html" class="hover-underline">
                                                    <h6 class="card-title mb-0">Cryptocurrency in 2025: Innovation or
                                                        Illusion?</h6>
                                                </a>
                                            </div>
                                        </div>
                ...
                <li class="nav-item position-relative">
                    <span class="badge-new">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10"
                            fill="none">
                            <path
                                d="M2.18102 5.83336H4.02138L3.64143 9.42543C3.63976 9.43626 3.6393 9.46831 3.6393 9.47914C3.6393 9.76624 3.87306 10 4.16016 10C4.3235 10 4.47929 9.92165 4.58267 9.78294L8.22266 4.58336C8.28972 4.49371 8.3268 4.38293 8.3268 4.27086C8.3268 3.98376 8.09311 3.75 7.80602 3.75H5.55351L5.9285 0.582047C5.92972 0.569992 5.93056 0.532913 5.93056 0.520859C5.93102 0.233765 5.69725 0 5.41016 0C5.24681 0 5.09102 0.0783539 4.98436 0.221252L1.7643 5C1.69724 5.08957 1.66016 5.20042 1.66016 5.3125C1.66016 5.59959 1.89392 5.83336 2.18102 5.83336Z"
                                fill="#0E0E0F" />
                        </svg>
                    </span>
                    <a class="nav-link link-effect-1 " href="archive-2.html"><span>Trending</span></a>
                </li>
                </ul>
                </div>
                ...
                <div class="d-flex align-items-center ms-auto gap-4">
                    <div class="pe-4 d-none d-lg-block">
                        <a href="page-login.html" class="text-decoration-underline link-effect-2">

                            <span class="text">
                                <span class="text1">Subscribe</span>
                                <span class="text2">Subscribe</span>
                            </span>
                        </a>
                    </div>
                    <div data-bs-toggle="modal" data-bs-target="#popupSearch"
                        ...
                        <svg class="dark-mode-invert" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                            ...
                            <path
                                ...
                                stroke="#0E0E0F" stroke-width="1.74463" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <span class="text">
                    ...
                    <div class="group-btn-right d-flex align-items-center">
                        ...
                        <a href="#" class="navbar-toggler">
                            <svg class="dark-mode-invert" xmlns="http://www.w3.org/2000/svg" width="26"
                        ...
                        <div class="popup-search-content position-relative">
                            <a href="#" class="close-popup position-absolute top-0 end-0 m-3">
                                <svg class="dark-mode-invert" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M17.25 6.75L6.75 17.25" stroke="#0E0E0F" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M6.75 6.75L17.25 17.25" stroke="#0E0E0F" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </a>
                                    ...
                                    <div class="swiper swiper-popup-search">
                                        ...
                                        <div class="swiper-slide hover-up">
                                            <div class="article card-10 style-1">
                                                ...
                                                <div class="card-body">
                                                    <a href="#">
                                                        <h6 class="fs-7 mb-2 text-truncate-2">Breaking Down the Elements of
                                                            a Masterpiece Painting</h6>
                                                    </a>
                                        ...
                                        <div class="swiper-slide hover-up">
                                            <div class="article card-10 style-1">
                                                ...
                                                <div class="card-body">
                                                    <a href="#">
                                                        <h6 class="fs-7 mb-2 text-truncate-2">The Revival of Classical Art
                                                            in a Digital Age</h6>
                                                    </a>
                                                    <div class="d-flex align-items-center text-600">
                                                        <span class="fs-8">16 Jul, 2025</span>
                                        ...
                                        <div class="swiper-slide hover-up">
                                            <div class="article card-10 style-1">
                                                ...
                                                <div class="card-body">
                                                    <a href="#">
                                                        <h6 class="fs-7 mb-2 text-truncate-2">Must-See Art Exhibitions
                                                            Around the World This Year</h6>
                                                    </a>
                                                    <div class="d-flex align-items-center text-600">
                                                        <span class="fs-8">16 Jul, 2025</span>
                                                        <ul class="ps-4 m-0">
            ...
            <div class="block-popular">
                ...
                <div class="swiper-slide hover-up">
                    <div class="article card-10 style-2">
                        ...
                        <div class="card-body">
                            <a href="#">
                                <h6 class="fs-7 mb-2 text-truncate-2">Iconic Film Directors and Their Influence on Cinema
                                </h6>
                            </a>
                            <div class="d-flex align-items-center text-600">
                                <span class="fs-8">16 Jul, 2025</span>
                ...
                <div class="swiper-slide hover-up">
                    <div class="article card-10 style-2">
                        ...
                        <div class="card-body">
                            <a href="#">
                                <h6 class="fs-7 mb-2 text-truncate-2">Must-See Art Exhibitions Around the World This Year
                                </h6>
                            </a>
                            <div class="d-flex align-items-center text-600">
                                <span class="fs-8">16 Jul, 2025</span>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-10 offset-lg-1 offset-md-1">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb list-unstyled d-flex flex-row gap-2 align-items-center m-0 ps-0 py-4">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}"
                                        class="text-600 fs-7 hover-dark">Home</a>
                                </li>
                        ...
                        <div class="article card-info d-flex flex-wrap align-items-center gap-2 mt-4">
                            <a href="#" class="badge bg-1 fs-8">{{ $post->category->name ?? '-' }}</a>
                            <ul class="d-flex align-items-center text-600 m-0 ps-3">
                                <li>
                                    <p class="fs-8 m-0">{{ $post->read_time ?? '6 mins read' }}</p>
                                </li>
                            </ul>
                        ...
                        <div class="bottom mt-auto d-flex flex-wrap align-items-center gap-2 pt-4">
                            <a href="#" class="author d-flex align-items-center gap-2">
                                <img class="avatar avatar-md rounded-circle"
                                    src="{{ asset('assets/imgs/template/author/author-9.png') }}" alt="magzin" />
                                <span class="fs-7 text-dark fw-regular">{{ $post->user->name ?? $post->author }}</span>
                            </a>
                            ...
                            <div class="ms-md-auto ms-5 d-flex align-items-center gap-3 me-5">
                                ...
                                <a href="#" class="readers d-flex align-items-center fs-8">
                                    ...
                                    <span><span class="odometer text-nowrap"
                                            data-count="{{ $post->view_count ?? 0 }}"></span> views</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-10 offset-lg-1 offset-md-1">
                        ...
                        <p class="text-dark m-0">Being busy has become a badge of honor. We equate packed schedules with
                            importance and equate stillness with laziness. But chronic busyness often leaves us feeling
                            disconnected—from ourselves, from others, and from the present moment. Our minds race ahead to
                            the next task while our bodies lag behind, overwhelmed and fatigued.</p>
                        <p class="text-dark m-0">Slowing down doesn’t mean giving up ambition. It means reclaiming your
                            time, your attention, and your presence. It’s about living in alignment with what truly matters.
                        </p>
                        ...
                        <p class="text-dark m-0">When we pause, we allow space for reflection. Without constant noise and
                            motion, we gain perspective on what truly matters. Slowing down helps us make better
                            decisions—not just faster ones. Fast living often robs us of joy. We rush through meals,
                            conversations, and even achievements without fully experiencing them. Moving at a slower pace
                            lets us savor small pleasures: a hot cup of tea, a sunset, a moment of silence.</p>
                        <p class="text-dark m-0">Constant urgency places immense strain on our nervous system. Slowing down
                            restores balance. It allows our minds to reset and our bodies to heal—preventing the long-term
                            toll of chronic stress.</p>
                        <blockquote class="blockquote">
                            <p class="text-dark m-0 fs-22 fw-medium">There’s more to life than simply increasing its speed.
                                In quiet pauses, we reconnect with who we are, what we love, and why it all matters.</p>
                        ...
                        <ul class="list-unstyled ps-0 m-0">
                            <li>
                                <p class="text-dark m-0 fw-semi-bold">Start your day slowly:<span
                                        class="text-600 fw-regular"> Resist the urge to check your phone the moment you
                                        wake
                                        up. Take a few deep breaths, stretch, or journal. Focus on one thing at a time. Eat
                                        without distraction. Walk without headphones. Listen without interrupting.</span>
                                </p>
                            </li>
                            <li>
                                <p class="text-dark m-0 fw-semi-bold">Take mindful breaks:<span
                                        class="text-600 fw-regular">
                                        Step away from your screen. Breathe. Step outside. Reconnect with your senses. Say
                                        no to what drains you. Prioritize rest without guilt.</span></p>
                            </li>
                            <li>
                                <p class="text-dark m-0 fw-semi-bold">Practice gratitude<span class="text-600 fw-regular">
                                        :
                                        Slowing down helps you notice what’s already good in your life—moments often missed
                                        in the rush.</span></p>
                            </li>
                        </ul>
                        <h4 class="mb-0">Slowness as a Strength</h4>
                        <p class="text-dark m-0">The art of slowing down is not about doing less—it’s about doing better.
                            When we take our time, we live more fully. We give ourselves the chance to savor, to reflect, to
                            connect, and to be human in a world that constantly pushes us to be machines.</p>
                        <p class="text-dark m-0">In choosing slowness, we choose intention over impulse, meaning over
                            momentum. We learn that life isn’t a race to the finish line—but a journey best experienced one
                            mindful step at a time.</p>
                        <h4 class="mb-0">Conclusion</h4>
                        <p class="text-dark m-0">Slowing down is not about falling behind—it’s about catching up with
                            yourself. In a culture that glorifies constant motion, choosing stillness is a courageous act.
                            It's a return to intention, to presence, and to the quieter rhythms of life that often hold the
                            greatest meaning.</p>
                        <p class="text-dark m-0">Whether it's taking a deep breath between tasks, unplugging for an
                            afternoon, or simply savoring your morning coffee without distraction, each small act of
                            slowness is a step toward a more mindful, fulfilling life.s</p>
                        ...
                        <div
                            class="block-subscribe h-100 d-flex flex-column flex-lg-row gap-3 justify-content-between bg-200 wow img-custom-anim-top">
                            <div>
                                <div class="block-title d-flex align-items-center gap-1 fs-7 text-600">
                                    ...
                                    <span class="fs-7 fw-regular">Newsletter</span>
                                </div>
                                <div class="title">
                                    <h5 class="mb-0">
                                        Stay Informed with <br class="d-none d-lg-block">
                                        Top Headlines
                                    </h5>
                                </div>
                            </div>
                            <div class="decorate-1 mix-blend-multiply bottom-0"
                                data-background="assets/imgs/template/decorate-3.png"></div>
                            <form action="#" class="position-relative">
                                ...
                                <label for="subscribe" class="text-600 fs-8">By clicking the button, you are agreeing with
                                    our <a href="#" class="text-dark">Term & Conditions</a></label>
                            </form>
                        </div>
                        <h4 class="mt-5 mb-2 pb-4 pt-3">Leave a comment</h4>
                        <div class="row wow img-custom-anim-top g-3 border-top">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control ms-0" name="name" placeholder="Website"
                                        aria-label="website">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group d-flex">
                                    <div
                                        ...
                                        <svg class="dark-mode-invert" xmlns="http://www.w3.org/2000/svg" width="18"
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-dark rounded-8 gap-2 button-effect-1">
                                    Submit comment
                                    <svg class="dark-mode-invert ms-2" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <h4 class="mt-5 mb-2 pt-3 wow img-custom-anim-top">Comments</h4>
                        <div
                            class="d-flex flex-wrap flex-lg-nowrap gap-4 align-items-start pt-4 border-top wow img-custom-anim-top">
                            <img class="rounded-16 avatar-xl" src="assets/imgs/template/author/author-18.png"
                                alt="magzin">
                            <div>
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <h6 class="mb-0 fs-6 text-900 fw-">Tromas H. Hendson</h6>
                                    <span class="mb-0 fs-6 text-500">June 9, 2025</span>
                                </div>
                                <p class="py-3 m-0 tex-500">Variations in the floor plan, window location, and interstitial
                                    outdoor spaces enhance this material homogeneity. The goal was to produce a unified
                                    whole using a modern design language, where attention to materiality and detail is
                                    evident. All flats have two sides and are in close proximity to the outside world.</p>
                                <a href="#" class="d-inline-flex text-600 hover-dark">
                                    <span class="bg-200 fs-8 rounded-8 py-2 px-3"> Reply </span>
                                </a>
                            </div>
                        </div>
                        <div class="border-top"></div>
                        <div
                            class="d-flex flex-wrap flex-lg-nowrap gap-4 align-items-start pt-4 ms-5 ps-5 wow img-custom-anim-top">
                            <img class="rounded-16 avatar-xl" src="assets/imgs/template/author/author-15.png"
                                alt="magzin">
                            <div>
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <h6 class="mb-0 fs-6 text-900 fw-">Rosalina D.</h6>
                                    <span class="mb-0 fs-6 text-500">June 10, 2025</span>
                                </div>
                                <p class="py-3 m-0 tex-500">Variations in the floor plan, window location, and interstitial
                                    outdoor spaces enhance this material homogeneity. The goal was to produce a unified
                                    whole using a modern design language, where attention to materiality and detail is
                        ...
                        <div
                            class="d-flex flex-wrap flex-lg-nowrap gap-4 align-items-start border-top pt-4 wow img-custom-anim-top">
                            <img class="rounded-16 avatar-xl" src="assets/imgs/template/author/author-9.png"
                                alt="magzin">
                            <div>
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <h6 class="mb-0 fs-6 text-900 fw-">Miranda H. Halim</h6>
                                    <span class="mb-0 fs-6 text-500">June 9, 2025</span>
                                </div>
                                <p class="py-3 m-0 tex-500">Variations in the floor plan, window location, and interstitial
                                    outdoor spaces enhance this material homogeneity. The goal was to produce a unified
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="article card-5">
                        <div class="post-link">
                            <div class="hover-effect-1">
                                <div class="position-relative card-img-top thumbnail">
                                    ...
                                    <a href="archive-1.html" class="badge bg-1 fs-8">Culture</a>
                                </div>
                            </div>
                            <div class="card-corner white no-border">
                                <a href="single-1.html" class="arrow-box">
                        ...
                        <div class="card-body mt-4">
                            <a href="single-1.html" class="hover-underline">
                        ...
                        <div class="post-link">
                            <div class="hover-effect-1">
                                <div class="position-relative card-img-top thumbnail">
                                    ...
                                    <a href="archive-1.html" class="badge bg-1 fs-8">Education</a>
                                </div>
                            </div>
                            <div class="card-corner white no-border">
                                <a href="single-1.html" class="arrow-box">
                        ...
                        <div class="post-link">
                            <div class="hover-effect-1">
                                <div class="position-relative card-img-top thumbnail">
                                    ...
                                    <a href="archive-1.html" class="badge bg-1 fs-8">Lifestyle</a>
                                </div>
                            </div>
                            <div class="card-corner white no-border">
                                <a href="single-1.html" class="arrow-box">
                        ...
                        <div class="post-link">
                            <div class="hover-effect-1">
                                <div class="position-relative card-img-top thumbnail">
                                    ...
                                    <a href="archive-1.html" class="badge bg-1 fs-8">Technology</a>
                                </div>
                            </div>
                            <div class="card-corner white no-border">
                                <a href="single-1.html" class="arrow-box">
